...
//     //   // headers: headers
//     // });
//     const req = new HttpRequest('PUT', 'https://ng-recipe-book-a67b6.firebaseio.com/recipes.json', this.recipeService.getRecipes(), {reportProgress: true});
//     return this.httpClient.request(req);
//   }

//   getRecipes() {
//     // this.httpClient.get<Recipe[]>('https://ng-recipe-book-a67b6.firebaseio.com?auth=' + token)
